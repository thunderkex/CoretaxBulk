...
2. Extract and go to `about:debugging`
...
### Chrome Development
Navigate to `chrome/` directory and load in Chrome developer mode

### Firefox Development  
Navigate to `firefox/` directory and load in Firefox developer mode
...
Automated releases via GitHub Actions include:
...
**Made with ❤️ by [Thunderkex](https://github.com/thunderkex/)**
